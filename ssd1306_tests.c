...
void ssd1306_TestBorder() {
    ...
    uint32_t start = ssd1306_wrapper_get_tick();
    uint32_t end = start;
    uint8_t x = 0;
    uint8_t y = 0;
    do {
        ...
        //ssd1306_wrapper_delay(5);
        end = ssd1306_wrapper_get_tick();
    } while((end - start) < 8000);
   
    //ssd1306_wrapper_delay(1000);
}
